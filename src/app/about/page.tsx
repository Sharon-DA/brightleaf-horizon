...
export default function AboutPage() {
  return (
    <div className="bg-white">
      ...
      {/* Social Media Links */}
      <footer className="py-12 px-6 bg-slate-50 border-t border-gray-200 mt-12">
        <div className="max-w-5xl mx-auto flex flex-col items-center gap-4">
          <span className="text-slate-700 font-semibold text-lg mb-2">Connect with us:</span>
          <div className="flex gap-6">
            <a href="https://www.linkedin.com/company/brightleaf-horizon/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="hover:text-amber-600 text-2xl">
            ...
            <a href="https://www.facebook.com/profile.php?id=61587168273948" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="hover:text-amber-600 text-2xl">
              <svg width="28" height="28" fill="currentColor" viewBox="0 0 24 24"><path d="M22.675 0h-21.35c-.733 0-1.325.592-1.325 1.326v21.348c0 .733.592 1.326 1.325 1.326h11.495v-9.294h-3.128v-3.622h3.128v-2.671c0-3.1 1.893-4.788 4.659-4.788 1.325 0 2.463.099 2.797.143v3.24l-1.918.001c-1.504 0-1.797.715-1.797 1.763v2.312h3.587l-.467 3.622h-3.12v9.293h6.116c.73 0 1.323-.593 1.323-1.326v-21.35c0-.734-.593-1.326-1.326-1.326z"/></svg>
            </a>
            <a href="https://x.com/" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)" className="hover:text-amber-600 text-2xl">
              <svg width="28" height="28" fill="currentColor" viewBox="0 0 24 24"><path d="M17.53 2.47a2.5 2.5 0 0 1 3.54 3.54l-4.88 4.88 4.88 4.88a2.5 2.5 0 0 1-3.54 3.54l-4.88-4.88-4.88 4.88a2.5 2.5 0 0 1-3.54-3.54l4.88-4.88-4.88-4.88a2.5 2.5 0 0 1 3.54-3.54l4.88 4.88 4.88-4.88z"/></svg>
            </a>
          </div>
        </div>
      </footer>
